...
const StarRating = ({ rating = 0 }: { rating?: ProductChatMessage['rating'] }) => {
...
export const ChatPage = () => {
  ...
  const [reviewRating, setReviewRating] = useState<0 | 1 | 2 | 3 | 4 | 5>(0)
        ...
        {showReviewComposer && (
          <section className="chat-review-composer" aria-label="Leave seller review">
            ...
            <div className="chat-review-stars" role="radiogroup" aria-label="Choose a rating">
              {([1, 2, 3, 4, 5] as const).map((value) => (
                <button
                  ...
                  className={`icon-btn review-star-btn ${reviewRating >= value ? 'active' : ''}`}
                  type="button"
            ...
            <textarea
              ...
              rows={3}
            />
            <button className="btn" type="button" disabled={reviewSubmitting || reviewRating === 0 || !reviewText.trim()} onClick={() => void submitOrderReview()}>
