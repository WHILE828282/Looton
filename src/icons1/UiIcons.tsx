...
export const TonIcon = ({ className }: { className?: string }) => <svg className={className} viewBox="0 0 24 24" fill="none" aria-hidden><circle cx="12" cy="12" r="10" fill="#229ED9"/><path d="M8 7h8.5c.9 0 1.4 1.1.8 1.8l-4.5 5.2a1 1 0 0 1-1.5 0L7.2 8.8C6.6 8.1 7.1 7 8 7Z" fill="#fff"/><path d="M12 14.2v3.2" stroke="#fff" strokeWidth="1.6" strokeLinecap="round"/></svg>
